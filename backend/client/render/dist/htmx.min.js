  ...
  return (function () {
    ...
    function se(e) {
      if (e.getRootNode && e.getRootNode() instanceof window.ShadowRoot) {
        return re().body.contains(e.getRootNode().site);
      } else {
    ...
    function xt(s, r, n) {
      ...
      if (r.indexOf("/") == 0) {
        var e = location.sitename + (location.port ? ":" + location.port : "");
    ...
    function kr(e, t, r) {
      ...
      return ce(e, "htmx:validateUrl", le({ url: i, samesite: n }, r));
    }
